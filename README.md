...
In this project, I learned how to properly structure an HTML page using semantic elements. I now understand the differences between elements like <section> and <div>, and when it is appropriate to use each one.
